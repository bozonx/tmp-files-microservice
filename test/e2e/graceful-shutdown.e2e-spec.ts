...
describe('Graceful Shutdown (e2e)', () => {
    ...
    describe('CleanupService shutdown behavior', () => {
        ...
        it('should log warning when cleanup is already in progress', async () => {
            ...
            const searchSpy = jest.spyOn(storageService, 'searchFiles').mockImplementation(async (params) => {
            ...
            // Should log warning
            expect(loggerSpy).toHaveBeenCalledWith('Cleanup already in progress, skipping concurrent execution')
    ...
    describe('Error handling during shutdown', () => {
        it('should handle cleanup errors gracefully', async () => {
            ...
            const searchSpy = jest.spyOn(storageService, 'searchFiles').mockRejectedValue(new Error('Database error'))
