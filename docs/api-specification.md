...
- Базовый URL формируется как: `/{API_BASE_PATH}/{API_VERSION}`
- По умолчанию: `/api/v1`
...
- Значение `ttl` — в секундах. Если клиент работает в минутах (например, n8n-нода), конвертируйте в секунды до отправки.
